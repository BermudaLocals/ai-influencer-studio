...
ALTER TABLE content_posts ADD COLUMN IF NOT EXISTS views BIGINT DEFAULT 0;
ALTER TABLE content_posts ADD COLUMN IF NOT EXISTS likes INTEGER DEFAULT 0;
ALTER TABLE content_posts ADD COLUMN IF NOT EXISTS comments INTEGER DEFAULT 0;
ALTER TABLE content_posts ADD COLUMN IF NOT EXISTS shares INTEGER DEFAULT 0;
ALTER TABLE content_posts ADD COLUMN IF NOT EXISTS viral_score INTEGER DEFAULT 0;
ALTER TABLE content_posts ADD COLUMN IF NOT EXISTS avatar_id UUID REFERENCES influencers(id) ON DELETE CASCADE;
